  ...
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper">
      ...
      <div class="toggle-sidebar" @click="toggle_sidebar">
        <i class="bi-grid" style="font-size: 1.2rem;" id="sidebar-toggle"></i>
      </div>
    </div>
    ...
    <div class="nav-right col-8 pull-right right-header p-0">
      <ul class="nav-menus">
        <li>
          <span class="header-search"><i class="bi-search" @click="search_open()"></i></span>
        </li>
        <li class="onhover-dropdown">
          <div class="notification-box">
            <i class="bi-bell"></i><span class="badge badge-pill badge-secondary">4 </span>
          </div>
